    ...
    <>
      <Row style={useStyles.marginrowtop50}>
        <Col xs={12} sm={12} md={12} lg={12}>
          <span className="mainheadingsuccess">{props.heading}</span>
        </Col>
      </Row>
      <Row style={useStyles.marginrowtop42}>
        ...
        <Col xs={12} sm={12} md={12} lg={12} style={useStyles.marginrowtop}>
          <span className="secondmainheadingsuccess">{props.imageText}</span>
        </Col>
      </Row>
      <Row style={useStyles.marginrowtop}>
        <Col xs={12} sm={12} md={12} lg={12}>
          <span style={useStyles.message}>{props.firstmsg}</span>
        </Col>
        <Col xs={12} sm={12} md={12} lg={12}>
          <span style={useStyles.message}>{props.secondmsg}</span>
        </Col>
      </Row>
      <Row style={useStyles.marginrowtop}>
        <Col xs={12} sm={12} md={12} lg={12}>
