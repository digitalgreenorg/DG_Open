...
import "./LeftintroParticipant.css";

export default function LeftintroParticipant() {
  return (
    <>
      <div class="leftintroparticipant">
        {/* <img
        ...
        Coordinate and connect multiple private and public sector organizations, institutions, and individuals to create a systematic interconnection of insights
        </h2>
        <img
          src="https://cdn.londonandpartners.com/visit/general-london/areas/river/76709-640x360-houses-of-parliament-and-london-eye-on-thames-from-above-640.jpg"
          alt=""
        ...
        Welcome FPOs, Government institutions, and civil society players to work together as learners, providers, and consumers in this fair multi-user network.
        </h2>
        {/* <img
          src="https://cdn.londonandpartners.com/visit/general-london/areas/river/76709-640x360-houses-of-parliament-and-london-eye-on-thames-from-above-640.jpg"
          alt=""
        ...
        This centralized structure enables a closed network of peers to build trust and bridges the gap via protected connectors.
        </h2>
        {/* <img
          src="https://cdn.londonandpartners.com/visit/general-london/areas/river/76709-640x360-houses-of-parliament-and-london-eye-on-thames-from-above-640.jpg"
          alt=""
        ...
        Exchange information and data in a trustworthy manner without having to monetize or pay for insights. Use the data to build your network and gather information systematically for the greater benefit of farmers.
        </h2>
      </div>
    </>
  );
