...
def migrate_forward(op, old_orm, new_orm):
    op.create_table(new_orm.language)
    op.create_table(new_orm.user)
    op.create_table(new_orm.conversation)
    op.create_table(new_orm.followupquestion)
    op.create_table(new_orm.messages)
    op.create_table(new_orm.generationmetrics)
    op.create_table(new_orm.messagemediafiles)
    op.create_table(new_orm.multilingualtext)
    op.create_table(new_orm.rephrasemetrics)
    op.create_table(new_orm.rerankedchunk)
    op.create_table(new_orm.rerankmetrics)
    op.create_table(new_orm.resource)
    op.create_table(new_orm.retrievalmetrics)
    op.create_table(new_orm.retrievedchunk)
    op.create_table(new_orm.useractions)
    op.run_data_migration()


def migrate_backward(op, old_orm, new_orm):
    op.run_data_migration()
    op.drop_table(old_orm.useractions)
    op.drop_table(old_orm.retrievedchunk)
    op.drop_table(old_orm.retrievalmetrics)
    op.drop_table(old_orm.resource)
    op.drop_table(old_orm.rerankmetrics)
    op.drop_table(old_orm.rerankedchunk)
    op.drop_table(old_orm.rephrasemetrics)
    op.drop_table(old_orm.multilingualtext)
    op.drop_table(old_orm.messagemediafiles)
    op.drop_table(old_orm.generationmetrics)
    op.drop_table(old_orm.messages)
    op.drop_table(old_orm.followupquestion)
    op.drop_table(old_orm.conversation)
    op.drop_table(old_orm.user)
    op.drop_table(old_orm.language)
